...
export default function Sidebar({ activeFilter, onFilterChange }: SidebarProps) {
                        ...
                        <li key={item.name}>
                            {title === "Feedback" ? (
                                <button
                                    ...
                                    className={`group w-full flex items-center justify-between rounded-sm px-4 py-3 text-sm font-medium transition-all duration-300 ease-out ${isActive
                                ...
                                >
                                    <div className={`flex items-center gap-3 transition-transform duration-300 ease-out ${isActive ? "animate-[slideIn_0.3s_ease-out]" : "group-hover:translate-x-1"}`}>
                                        <item.icon size={18} className={`transition-transform duration-300 ease-out ${isActive ? "animate-[scaleIn_0.3s_ease-out]" : "group-hover:scale-110"}`} />
                                        {item.name}
                                    </div>
    ...
    return (
        <div className="hidden lg:flex w-64 h-full bg-black border-r border-neutral-800/70 flex-col p-6">
            {/* Logo Area */}
            ...
            <div className="mt-auto pt-6">
                ...
                >
                    {isLoading ? (
                        ...
                        <LogOut size={18} className="transition-transform duration-300 ease-out group-hover:scale-110" />
                    )}
